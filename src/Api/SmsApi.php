 ...
 * @since 1.0
 */
class SmsApi extends HaotingyunApi {
    
    const NAME = "sms";

    function init(HaotingyunClient $clnt) {
        parent::init($clnt);
        $this->host($clnt->conf(self::HT_SMS_HOST, 'http://sms.haotingyun.com'));
    }
     ...
     * </p>
     * <p>
     * text String 是 短信内容 【豪霆云】您的验证码是1234
     * </p>
     * <p>
     ...
     * 内容示意：UrlEncode("【豪霆云】您的验证码是1234", "UTF-8") + "," +
     * UrlEncode("【豪霆云】您的验证码是5678", "UTF-8")
     * </p>
     * <p>
     * extend String 否 扩展号。默认不开放，如有需要请联系客服申请 001
     * </p>
     ...
     * 注：变量名和变量值都不能为空 模板： 【#company#】您的验证码是#code#。 最终发送结果： 【豪霆云】您的验证码是1234。
     * tplvalue=urlencode("#code#") + "=" + urlencode("1234") + "&amp;" +
     * urlencode("#company#") + "=" + urlencode("豪霆云"); 若您直接发送报文请求则使用下面这种形式
     * tplvalue=urlencode(urlencode("#code#") + "=" + urlencode("1234") + "&amp;" +
     * urlencode("#company#") + "=" + urlencode("豪霆云"));
     * </p>
     * <p>
     * extend String 否 扩展号。默认不开放，如有需要请联系客服申请 001
     * </p>
