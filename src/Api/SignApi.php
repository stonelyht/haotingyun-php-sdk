 ...
 * @since 1.0
 */
class SignApi extends HaotingyunApi {
    
    const NAME = "sign";

    function init(HaotingyunClient $clnt) {
        parent::init($clnt);
        $this->host($clnt->conf(self::HT_SIGN_HOST, 'http://sms.haotingyun.com'));
    }
     ...
     * </p>
     * <p>
     * old_sign String 是 完整签名内容，用于指定修改哪个签名，可以加【】也可不加 豪霆云
     * </p>
     * <p>
     * sign String 否 修改后的签名内容（如果要改签名内容） 豪霆云
     * </p>
     * <p>
